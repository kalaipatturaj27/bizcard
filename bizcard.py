...
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By KALAISELVI",
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *KALAI SELVI*!"""})
...
drop_query=''' drop table if exists card_data'''
cursor.execute(drop_query)
mydb.commit()
# TABLE CREATION

creat_query = '''CREATE TABLE IF NOT EXISTS card_data
